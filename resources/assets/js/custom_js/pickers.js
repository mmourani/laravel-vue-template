...
$(document).ready(function(){
    $(".input-group-addon b").removeClass("glyphicon glyphicon-list-alt").addClass("fa fa-list-alt")
    $(".picker-switch a span").removeClass("glyphicon-time glyphicon").addClass("fa fa-clock-o");
    $(".bootstrap-touchspin-down i").removeClass("glyphicon glyphicon-minus").addClass("fa fa-minus");
    $(".bootstrap-touchspin-up i").removeClass("glyphicon glyphicon-plus").addClass("fa fa-plus");
    $('i.glyphicon.glyphicon-search').removeClass('glyphicon glyphicon-search').addClass('fa fa-search');
    $('i.glyphicon.glyphicon-remove-circle').removeClass('glyphicon glyphicon-remove-circle').addClass('fa fa-close');
})
