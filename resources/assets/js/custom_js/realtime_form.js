...
// date picker
    ...
    $('#add-flight').on('click', function () {
        if (i < 4) {
            var from_city = "<div class='col-sm-4 col-6'> <div class='form-group'> <label class='control-label'>From <input type='text' class='form-control' placeholder='Origin City'> </label> </div> </div>";
            var icon_indi = "<div class='col-sm-1 hidden-xs'> <div class='trip-type-multi'> <i class='fa ti-arrow-right icon'></i> </div> </div>";
            var to_city = "<div class='col-sm-4 col-6'> <div class='form-group'> <label class='control-label'>To <input type='text' class='form-control' placeholder='Destination City'> </label> </div> </div>";
            var dep_date = "<div class='col-sm-3 col-sm-offset-0 col-12'><span class=''><i class='fa fa-fw ti-minus remove-flight'></i></span> <label class='m-l-16 m-r-20'>Departure <div class='input-group'> <div class='input-group-addon'> <i class='fa fa-fw ti-calendar'></i></div> <input class='form-control departure_date' placeholder='Select Date'> </div></label> </div>";
