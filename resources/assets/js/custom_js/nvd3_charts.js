...
$(document).ready(function () {
    ...
    nv.addGraph(function () {
        ...
        $('#chart4').closest('.card-body').on('resize', function () {
    ...
    nv.addGraph(function () {
        ...
        $('#chart5').closest('.card-body').on('resize', function () {
    ...
    nv.addGraph(function () {
        ...
        $('#chart2').closest('.card-body').on('resize', function () {
    ...
    nv.addGraph(function () {
        ...
        $('#chart3').closest('.card-body').on('resize', function () {
    ...
    nv.addGraph(function () {
        ...
        $('#chart1').closest('.card-body').on('resize', function () {
...
// area chart
    nv.addGraph(function () {
        ...
        $('#chart6').closest('.card-body').on('resize', function () {
...
// sunburst chart
    ...
    nv.addGraph(function () {
        ...
        $('#chart7').closest('.card-body').on('resize', function () {
