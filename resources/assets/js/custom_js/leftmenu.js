...
//Code for collpasing cards

$(document).on('click', '.card-header .removecard', function() {
    var $this = $(this);
...
$(document).on('click', '.card-header .clickable', function(e) {
    ...
    if (!$this.hasClass('card-collapsed')) {
        ...
        $this.addClass('card-collapsed').removeClass('ti-angle-up').addClass('ti-angle-down');
        $('.showhide').attr('title', 'Show card content');
    } else {
        $this.closest('.card').find('.card-body').slideDown();
        $this.removeClass('card-collapsed').removeClass('ti-angle-down').addClass('ti-angle-up');
        $('.showhide').attr('title', 'Hide card content');
    }
});
//leftmenu init
