            ...
            onAfterEventsLoad: function (events) {
                ...
                $.each(events, function (key, val) {
                    ...
                    $(document.createElement('li'))
                        .html('<a href="' + val.url + '" class="text-' + eventclass + '">' + val.title + '<span class="float-right delete_event" title="Remove"><i class="fa ti-close showbtns" aria-hidden="true"></i></span></a>')
                        .appendTo(list);
                });
            },
