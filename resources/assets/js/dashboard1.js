...
$(document).ready(function () {
    ...
    //auto timeline update card ends
    ...
    $("form#main_input_box").submit(function (event) {
        ...
        var delay = 3500;
        setTimeout(function () {
            conversation_list.append('<li class="clearfix m-t-10 conversers2"><div class="conversation-text"><div class="ctext-wrap"><p class="pull-left reply">Wilton is typing<div class="spinner float-right"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></p></div></div></li>');
