...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="css/custom_css/dropify.css">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body p-30">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="h5pnl_font">Dropify Basic</h5>
                                    <input type="file" class="dropify"/>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="h5pnl_font">AllowedFileExtensions (PDF, PNG and PSD )</h5>
                                    <input type="file" class="dropify" data-allowed-file-extensions="pdf png psd"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="h5pnl_font">Max File Size</h5>
                                    <input type="file" data-max-file-size="3M"/>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="h5pnl_font">Disabled</h5>
                                    <input type="file" class="dropify" disabled="disabled"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="h5pnl_font">Default File</h5>
                                    <input type="file" class="dropify" data-default-file="img/pages/slider2.jpg"/>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="h5pnl_font">Without Remove Button</h5>
...
@section('scripts')
    ...
    <script src="js/custom_js/dropify_custom.js" type="text/javascript"></script>
