...
<head>
    <meta charset="UTF-8">
    <title>Menubar Fold | Clear Admin Template</title>
    ...
    <link href="css/menubarfold.css" rel="stylesheet">
    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            <div id="menu" role="navigation">
                ...
                <ul class="navigation">
                    <li class="menu-dropdown left_li">
                        <a href="#">
                        ...
                        <ul class="sub-menu">
                            <li>
                                ...
                                <ul class="sub-menu p-l-40">
                                    <li><a href="form_elements"> <i class="fa fa-fw ti-cup"></i> Form Elements </a>
                                    </li>
                                    <li><a href="realtime_form"> <i class="fa fa-fw ti-write"></i> Realtime Forms
                                    </a></li>
                                    <li>
                    ...
                    <li class="menu-dropdown left_li">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="transitions">
                                    <i class="fa fa-fw ti-star"></i> Transitions
                                </a>
                            </li>
                    ...
                    <li class="menu-dropdown left_li">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="widgets">
                                    <i class="fa fa-fw ti-widgetized"></i> Widgets 1
                                </a>
                            </li>
                            <li>
                                <a href="widgets1">
                                    <i class="fa fa-fw ti-widget-alt"></i> Widgets 2
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-dropdown left_li">
                        <a href="#"> <i class="menu-icon ti-layout-grid4"></i>
                        </a>
                        <ul class="sub-menu">
                            <li>
                    ...
                    <li class="menu-dropdown left_li">
                        <a href="#"> <i class="menu-icon ti-user"></i> </a>
                        <ul class="sub-menu">
                            <li>
                                <a href="users">
                    ...
                    <li class="menu-dropdown left_li active">
                        <a href="#">
                                                ...
                                                <ul class="sub-menu sub-submenu">
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="sub-menu sub-submenu">
                                                            <li>
                                                                <a href="#">
                                                                    <i class="fa fa-fw ti-control-skip-forward"></i>
                                                                    Level 5
                                                                </a>
                                                            </li>
                                                            <li>
...
<script src="js/custom_js/menubarfold.js" type="text/javascript"></script>
