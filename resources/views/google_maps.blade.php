...
@section('title')
    Google Maps | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
    <link rel="stylesheet" type="text/css" href="css/gmaps_cust.css">
...
@section('scripts')
    ...
    <script type="text/javascript" src="js/custom_js/custommaps.js"></script>
@stop
