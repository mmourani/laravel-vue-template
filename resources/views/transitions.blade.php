...
@section('title')
    Transtions | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
                            ...
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row text-center">
                                        <div class="col-md-12">
                                            <h5 class="h5pnl_fnt"> Click on the Ball to see an Animations</h5>
                                        </div>
                                    </div>
                                        ...
                                        <div class="wrap">
                                            <div class="row ">
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="tad"
                                                         alt="football">
                                                    <p>Tada</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="fls"
                                                         alt="football">
                                                    <p>Flash</p>
                                                ...
                                                <div class="col-lg-2 col-sm-3">
                                                    ...
                                                    <img src="img/football.png" id="shk"
                                                         alt="football">
                                                    <p>Shake</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                ...
                                                <div class="col-lg-2 col-sm-3">
                                                    ...
                                                    <img src="img/football.png" id="pul"
                                                         alt="football">
                                                    <p>Pulse</p>

                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="wobb"
                                                         alt="football">
                                                    <p>Wobble</p>

                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="jell"
                                                         alt="football">
                                                    <p>Jello</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="rubber"
                                                         alt="football">
                                                    <p>Rubber Band</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                ...
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="bid"
                                                         alt="football">
                                                    <p>Bounce In Down</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="bil"
                                                         alt="football">
                                                    <p>Bounce In Left</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="fiy"
                                                         alt="football">
                                                    <p>FlipInY</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="flp"
                                                         alt="football">
                                                    <p>Flip</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="fid"
                                                         alt="football">
                                                    <p>FadeIn Down</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="roi"
                                                         alt="football">
                                                    <p>Rotate In</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="lso"
                                                         alt="football">
                                                    <p>light Speed Out</p>
                                                </div>
                                                <div class="col-lg-2 col-sm-3">
                                                ...
                                                <div class="col-lg-2 col-sm-3">
                                                    <img src="img/football.png" id="lis"
                                                         alt="football">
                                                    <p>Light Speed In</p>
                                                </div>
                                            </div>
...
@section('scripts')
    ...
    <script type="text/javascript" src="js/custom_js/transitions_custom.js"></script>
