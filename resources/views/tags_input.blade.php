...
@section('title')
    Tags Input | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
    <link rel="stylesheet" href="vendors/insignia/css/insignia.css">
    <link type="text/css" rel="stylesheet" href="css/custom_css/insignia_custom.css">
