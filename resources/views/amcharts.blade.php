...
@section('title')
    Amcharts | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
    <link rel="stylesheet" href="vendors/amcharts/css/export.css" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="css/custom_css/amcharts.css">
...
@section('scripts')
    ...
    <script type="text/javascript" src="vendors/amcharts/js/amcharts.js"></script>
    <script type="text/javascript" src="vendors/amcharts/js/serial.js"></script>
    <script type="text/javascript" src="vendors/amcharts/js/export.min.js"></script>
    <script type="text/javascript" src="vendors/amcharts/js/light.js"></script>
    <script type="text/javascript" src="js/custom_js/amcharts.js"></script>
