...
@section('title')
    Calendar | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
    <link href="vendors/fullcalendar/css/fullcalendar.css" rel="stylesheet" type="text/css"/>
    <link href="vendors/fullcalendar/css/fullcalendar.print.css" rel="stylesheet" media='print' type="text/css">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <div class="box">
                        <div class="box-title">
                            <h3 class="draggable">Draggable Events</h3>
                        ...
                        <div class="modal-body">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button type="button" id="color-chooser-btn" class="btn dropdown-toggle"
...
@section('scripts')
    ...
    <script src="js/custom_js/calendar_custom.js" type="text/javascript"></script>
