...
@section('title')
    Image Magnifier | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        ...
                                        <img data-toggle="magnify" class="mag-style img-fluid"
                                             src="img/gallery/thumbs/24.jpg" alt="image">
                                    </a>
                                </div>
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        <br/>
                                        <img data-toggle="magnify" src="img/gallery/thumbs/30.jpg" alt="image"
                                ...
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        <br/>
                                        <img data-toggle="magnify" src="img/gallery/thumbs/20.jpg" alt="image"
                                             class="mag-style img-fluid">
                                    </a>
                                </div>
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        <br/>
                                        <img data-toggle="magnify" src="img/gallery/thumbs/29.jpg" alt="image"
                                             class="mag-style img-fluid">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top:40px;">
                                ...
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        <br/>
                                        <img data-toggle="magnify" src="img/gallery/thumbs/8.jpg" alt="image"
                                             class="mag-style img-fluid">
                                    </a>
                                </div>
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        <br/>
                                        <img data-toggle="magnify" src="img/gallery/thumbs/31.jpg" alt="image"
                                             class="mag-style img-fluid">
                                    </a>
                                </div>
                                <div class="col-6 col-lg-3 col-sm-6">
                            ...
                            <div class="row" style="margin-top:40px;">
                                ...
                                <div class="col-6 col-lg-3 col-sm-6">
                                    <a class="mag img-fluid">
                                        <br/>
                                        <img data-toggle="magnify" src="img/gallery/thumbs/17.jpg" alt="image"
                                             class="mag-style img-fluid">
                                    </a>
                                </div>
                                <div class="col-6 col-lg-3 col-sm-6">
...
@stop
@section('scripts')
    <script src="js/bootstrap-magnify.min.js" type="text/javascript"></script>
@stop
