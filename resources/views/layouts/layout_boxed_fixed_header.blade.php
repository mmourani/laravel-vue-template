...
<head>
    <meta charset="UTF-8">
    <title>Boxed Layout | Clear Admin Template</title>
...
<body class="skin-default boxed fixed-menu" id="fixed_box">
<div class="preloader">
            ...
            <div id="menu" role="navigation">
                ...
                <ul class="navigation">
                    ...
                    <li class="menu-dropdown active">
                        ...
                        <ul class="sub-menu">
                            <li><a href="menubarfold"> <i class="fa fa-fw ti-layout-menu-v"></i> Menubar Fold </a>
                            </li>
                            <li><a href="horizontal_menu"> <i class="fa fa-fw ti-layout-menu-full"></i> Horizontal
                                Menu </a></li>
                            <li><a href="mini_sidebar"> <i class="fa fa-fw ti-control-backward"></i> Mini Sidebar
                            </a></li>
                            <li>
...
&lt;/body&gt;</code></pre>
            ...
            <div class="col-lg-12">
                ...
                <p class="text-justify">
                    <img src="img/brick-wall.png" alt="holder image" class="img-fluid full_img">
                </p>
                <p>Lorem
                    ipsum
