...
<head>
    <meta charset="UTF-8">
    <title>Movable Header | Clear Admin Template</title>
    ...
    <link href="css/custom_css/layout.css" rel="stylesheet"/>
        ...
        <section class="content">
            <div class="outer">
                <div class="inner bg-light lter">
                    <h2>Code</h2>
                    <pre><code
                            class="language-markup">&lt;nav class=&quot;navbar-fixed-top&quot;&gt;...&lt;/nav&gt;</code></pre>
                </div>
                <!-- /.inner -->
            </div>
            <!--rightside bar -->
