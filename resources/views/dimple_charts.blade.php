...
@section('title')
    Dimple Charts | Clear Admin Template
@stop
@section('styles')
    <!--page level css -->
...
@section('scripts')
    ...
    <script type="text/javascript" src="js/d3.v4.3.0.min.js"></script>
    <script type="text/javascript" src="js/dimple.v2.3.0.min.js"></script>
    <script type="text/javascript" src="js/custom_js/dimple.js"></script>
