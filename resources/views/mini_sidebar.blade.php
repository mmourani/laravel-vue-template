...
<head>
    <meta charset="UTF-8">
    <title>Mini Sidebar | Clear Admin Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/mini_sidebar.css">
        ...
        <section class="sidebar">
            <div id="menu" role="navigation">
                ...
                <ul class="navigation">
                    ...
                    <li class="menu-dropdown mini_bar">
                    ...
                    <li class="menu-dropdown mini_bar">
                        <a href="#"> <i class="menu-icon ti-user"></i> <span class="mm-text">Users</span> <span
                    ...
                    <li class="menu-dropdown active mini_bar">
                        <a href="#">
...
<script type="text/javascript" src="js/custom_js/mini_sidebar.js"></script>
